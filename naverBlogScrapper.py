...
def get_blog_count(query, display):
    ...
    if response_code is 200:
        ...
        return render_template("main.html", blog_count_html=blog_count)

if __name__ == '__main__':
    app.run(host='localhost', port=550, debug=True)
...
def get_blog_post(query, display, start_index, sort):
    ...
    if response_code is 200:
        ...
        with open("C:\\Users\ksy\AppData\Local\Programs\Python\Python37/"+query+".json", 'w', encoding='utf-8') as j_file:
